 ...
 * - 은닉화 : 객체의 내부의 정보를 숨겨 외부로 드러나지않게 보호 하는 것
 * 
...
public class Polymorphism01 {
	...
	public static void main(String[] args) {
		...
		System.out.println("-- 조상의 객체로 자식의 객체를 생성 가능 --");
...
//		ex01.moveAnimal(dog); // animal 클래스를 상속받고 있지 않기 때문에 불가능.
		...
		// Human 클래스 객체에 Animal을 상속받은 Human 클래스 객체를 다운 캐스팅 예시
		Human h = (Human)hAnimal;
		h.readBook();
		
//		Human h1 = (Human)tAnimal;
//		h1.readBook(); // casting 오류
		// instanceof 연사자로 확인하여 실행
