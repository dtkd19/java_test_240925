...
//		System.out.println(a);
		...
		List<Integer> linkedList = new LinkedList<Integer>(); // LinkedList 생성
		...
		System.out.println(list);
		Integer re = 10;
		list.remove(re); // 그냥 숫자는 index로 보기때문에 객체를 만들어서 넣어가지고 지움.
		System.out.println(list);
		
		// contains(object) : list에 값이 있는지 검사 true / false 로 리턴 
		
		System.out.println(strList.contains("나"));
