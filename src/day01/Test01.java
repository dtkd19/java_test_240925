...
//		 System.out.println("콘솔 출력 텍스트") => sysout ( ctrl + space )
		...
		System.out.println("한글이지롱");
		
		// 타입별로 변수 유형을 결정해야 함.
		// String 문자형 => 기본타입이 아님. 참조형 타입
		// 변수타입 8가지 
		// 변수는 범위 (scope) { } 를 벗어나면 변수는 사용 할 수 없음.
...
//		System.out.println(num2); 범위를 벗어나서 error Exception
...
//		String s = 'a';
		...
		char ch = 'a';
		System.out.println( (int)ch ); // 유니코드(아스키) 표에 의해 변한된 10진수를 출력
		
		// long / float은  L(l) - 생략가능 / F(f) - 생략불가능 를 접미사로 표현
		// java 정수의 기본자료형 int 실수의 기본자료형 double 
		long l = 1234567L; // long 형의 특징
